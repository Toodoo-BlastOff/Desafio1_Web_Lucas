...
const learnCards = document.querySelectorAll(
  ".learn-cards-item .card-item-button",
);
const rocketInfo = [];
...
const mainRocketImg = document.querySelector(
  ".main-ships-container .rocket-image img",
);
